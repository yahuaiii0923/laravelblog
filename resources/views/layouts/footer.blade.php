<footer class="bg-blue-50 py-20">
    ...
    <div class="py-2 mt-12 bg-blue-50 w-4/5 mx-auto text-center">
            <div class="max-w-4xl mx-auto px-4">
                ...
                <div class="mt-8 max-w-md mx-auto flex gap-4">
                    ...
                    <button class="bg-cyan-400 text-white px-6 py-2 rounded-lg hover:bg-teal-600 transition-colors duration-300">
                        Subscribe
                    </button>
                </div>
            </div>
